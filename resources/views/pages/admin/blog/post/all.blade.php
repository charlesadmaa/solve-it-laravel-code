                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">All Blog
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item delete-all" href="javascript:void(0);"
                                                   data-url="{{route('manageBlogDeleteMultiple')}}">Delete
                                                </a>
                                                ...
                                                <tr id="tr_{{ $item->id }}">
                                                    ...
                                                    <td>
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar">
                                                                <span class="avatar-content not-rounded"><img src="{{ asset("storage/blog/".$item->featured_image)}}" alt="Avatar" height="32" width="32"></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{ Str::limit(strip_tags($item->body), 20) }}
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('manageBlogEdit', $item->id)}}">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   href="{{route('manageBlogDelete', $item->id)}}">
