                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add New Blog
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row  pt-15">
                                        <div class="col-md-6 offset-md-3">
                                            <hr class="mb-4">
                                            <form enctype="multipart/form-data" action="{{route('manageBlogAddPost')}}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="content" type="text"
                                                                      ...
                                                                      id="description" > {{ old('body') ?? ""}} </textarea>
                                                            @error('body')
                                                            <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                @foreach($users as $index => $item)
                                                                    <option value="{{$item->id}}" {{($item->id ==  auth()->user()->id)  ? 'selected' :  ''}} >
                                                                        {{$item->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                @foreach($categories as $index => $item)
                                                                    <option value="{{$item->id}}" {{in_array($item->id, (old('categories') ?? [])) ? 'selected' :  ''}} >
                                                                        {{$item->title}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="border rounded p-2">
                                                            ...
                                                            <div class="media flex-column flex-md-row">
                                                                <img src="{{ asset("storage/blog/default-image.png")}}" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="170" height="110" alt="Blog Featured Image">
                                                    ...
                                                    <div class="col-12 mt-2 mb-3 text-right">
                                                        <button type="submit"
                                                                class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Add Blog</button>
                                                    </div>
                                                </div>
                                            </form>
