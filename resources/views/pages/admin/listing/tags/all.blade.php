...
@section('title')
    Listing Tag List - SolveIt Admin
@endsection
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h4 class="content-header-title float-left mb-0">Listing Tags</h4>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('adminDashboard') }}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Listing Tags</a>
                                    </li>
                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <a class="btn btn-primary waves-effect waves-float waves-light"
                                           href="{{route('manageListingTagAdd')}}">
                                            Add New
                                        </a>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item delete-all" href="javascript:void(0);"
                                                   data-url="{{route('manageListingTagDeleteMultiple')}}">Delete
                                                </a>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('manageListingTagEdit', $item->id)}}">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   href="{{route('manageListingTagDelete', $item->id)}}">
