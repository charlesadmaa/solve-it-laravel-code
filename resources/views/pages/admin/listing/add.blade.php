                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add New Listing
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row  pt-15">
                                        <div class="col-md-6 offset-md-3">
                                            <form enctype="multipart/form-data" action="{{route('manageListingAddPost')}}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="amount" class="text-dark font-weight-bolder">Amount</label>
                                                        ...
                                                        <div class="border rounded p-2">
                                                            ...
                                                            <div class="media flex-column flex-md-row">
                                                                <img src="{{ asset("storage/product/default-image.png")}}" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="170" height="110" alt="Featured Image">
                                                        ...
                                                        <div class="form-group pt-2">
                                                            ...
                                                            <select class="select2 form-control text-dark font-weight-bolder" id="tag_id" name="tag_id">
                                                                ...
                                                                @foreach($productTags as $index => $item)
                                                                    <option value="{{$item->id}}" {{old('tag_id') ? 'selected' :  ''}} >
                                                                        {{$item->title}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-12 mt-2 mb-3 text-right">
                                                        <button type="submit"
                                                                class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Create Listing</button>
                                                    </div>
                                                </div>
                                            </form>
