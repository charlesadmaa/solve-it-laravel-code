                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">All Forum
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item delete-all" href="javascript:void(0);"
                                                   data-url="{{route('manageForumDeleteMultiple')}}">Delete
                                                </a>
                                                ...
                                                <tr id="tr_{{ $item->id }}">
                                                    ...
                                                    <td>
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar">
                                                                <span class="avatar-content not-rounded"><img src="{{ asset("storage/forum/".$item->featured_image)}}" alt="Avatar" height="32" width="32"></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('manageForumEdit', $item->id)}}">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   href="{{route('manageForumDelete', $item->id)}}">
