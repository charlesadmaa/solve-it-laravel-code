                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Forum</a>
                                    </li>
                                    <li class="breadcrumb-item active">Forum Comment
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <a class="btn btn-primary waves-effect waves-float waves-light"
                                           href="{{route('manageForumCommentAdd')}}">
                                            Add New
                                        </a>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item delete-all" href="javascript:void(0);"
                                                   data-url="{{route('manageForumCommentDeleteMultiple')}}">Delete
                                                </a>
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $key => $item)
                                                <tr id="tr_{{ $item->id }}">
                                                    ...
                                                    <td>
                                                        {{ Str::limit(strip_tags($item->message), 20) }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="profile-wrapper">
                                                            <div class="avatar-wrapper">
                                                                <div class="avatar">
                                                                    <span class="avatar-content not-rounded"><img src="{{ asset("storage/images/users/".$item->sender->avatar)}}" alt="Avatar" height="32" width="32"></span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('manageForumCommentEdit', $item->id)}}">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   href="{{route('manageForumCommentDelete', $item->id)}}">
