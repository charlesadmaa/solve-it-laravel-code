...
@section('title')
    Add New Forum-Comment - SolveIt Admin
@endsection
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add New Forum-Comment
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row  pt-15">
                                        <div class="col-md-6 offset-md-3">
                                            <hr class="mb-4">
                                            <form enctype="multipart/form-data" action="{{route('manageForumCommentAddPost')}}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control text-dark font-weight-bolder" id="forum_id" name="forum_id">
                                                                @foreach($forums as $index => $item)
                                                                    <option value="{{$item->id}}" {{old('forum_id') ? 'selected' :  ''}} >
                                                                        {{$item->title}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="border rounded p-2">
                                                            ...
                                                            <div class="media flex-column flex-md-row">
                                                                <img src="{{ asset("storage/forum/comment/default-image.png")}}" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="170" height="110" alt="Uploaded File">
