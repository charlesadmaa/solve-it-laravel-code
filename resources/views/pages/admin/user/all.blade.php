                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item delete-all" href="javascript:void(0);"
                                                   data-url="{{route('manageUserDeleteMultiple')}}">Delete
                                                </a>
                                                ...
                                                <tr id="tr_{{ $item->id }}">
                                                    ...
                                                    <td>
                                                        <div class="avatar-wrapper-bg">
                                                            <div class="avatar-bg">
                                                                <img src="{{ asset("/storage/images/users/".$item->avatar)}}" alt="Avatar" height="32" width="32">
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('manageUserEdit', $item->id)}}">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   href="{{route('manageUserDelete', $item->id)}}">
