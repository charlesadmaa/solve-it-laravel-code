                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">All Department
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <a class="btn btn-primary waves-effect waves-float waves-light"
                                           href="{{route('manageDepartmentAdd')}}">
                                            Add New
                                        </a>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item delete-all" href="javascript:void(0);"
                                                   data-url="{{route('manageDepartmentDeleteMultiple')}}">Delete
                                                </a>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('manageDepartmentEdit', $item->id)}}">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   href="{{route('manageDepartmentDelete', $item->id)}}">
